...
- Order 24 completed with 1024 final slices and nine nontrivial survivors.
  Because raw-stream counters were not retained, the page does not promote the
  candidate-population estimate to an exact count.
